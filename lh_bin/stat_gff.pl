...
open OUT1,">mRNA_length.txt" || die "can't open:$!";
open (OUT2,">>average.txt") || die "can't open:$!";
open (OUT3,">cds_length.txt") || die "can't open:$!";
open (OUT4,">exon_length.txt") || die "can't open:$!";
open (OUT5,">exon_number.txt") || die "can't open:$!";
open (OUT6,">intron_length.txt") || die "can't open:$!";
