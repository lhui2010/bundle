...
ggplot(tb, aes(Loci, Fst,  color = Group)) +
    geom_point() +
    scale_x_continuous(breaks=seq(4071880, 4079946, 800))+
    geom_hline(yintercept = 0.2455621, color = 'coral', linetype="dashed") +
    geom_hline(yintercept = 0.8305817, color = 'steelblue', linetype="dashed") +
    theme_bw()
