...
#Mon Nov 15 14:07:13 CST 2021
#Use NG86 as Ka Ks model

#Wed Oct 20 16:42:06 CST 2021
#Use YN00 as Ka Ks calculation
...
sub KaKsCommands {
	...
	for (my $i=0; $i<@files; $i++) {
		my $file = $files[$i];
        my $cmd = $KaKsCMD." -i ".$file.".cds_aln.axt -m ".$Model." -o  ".$file.".cds_aln.axt.kaks >> msg.kaks";
