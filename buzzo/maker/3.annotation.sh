...
#split_fastav3.pl ref.fa  24
perl $DIR/split_fasta_each.pl ref.fa  240
rm ref.fa
...
est=${DIR}/input/japonica_transcripts.fasta #set of ESTs or assembled mRNA-seq in fasta format
...
est_gff=${DIR}/input/stringtie.gff #aligned ESTs or mRNA-seq from an external GFF3 file
...
#3.01.02
        bsub -q Q104C512G_X4 -J mk$i -o maker.$i.log -e maker.$i.err " export AUGUSTUS_CONFIG_PATH=/tmp/lh_config && /ds3200_1/users_root/yitingshuang/lh/bin/maker/bin/maker -R $OPT maker_bopts.ctl maker_exe.ctl"
        sleep 10s
